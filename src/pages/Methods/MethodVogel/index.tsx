...
const MethodVogel: React.FC = () => {
  ...
  // Calcular penalizaciones (código existente)
  ...
  // Seleccionar la mejor penalización (código existente)
  ...
  // Encontrar la mejor celda (código existente)
  ...
  // Continuar con método de costo mínimo (código existente)
  ...
  // Algoritmo principal de Vogel con MODI
  const solveVogelMethod = (): void => {
    ...
    // Ejecutar Vogel (código existente)
  ...
  // Funciones auxiliares para la UI (código existente)
  const resetAll = (): void => {
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2 flex items-center justify-center gap-3">
            ...
            Método de Vogel + Optimización MODI
          </h1>
          <p className="text-lg text-gray-600">Algoritmo de Penalizaciones con Verificación de Optimalidad</p>
        </div>
        ...
        {solution && (
          <div className="space-y-6">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-white/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-800 mb-2">Solución Inicial (Vogel)</h4>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              >
                <FileText size={18} />
                {showProcess ? 'Ocultar Proceso Vogel' : 'Ver Proceso Vogel'}
              </button>
            ...
            {/* Proceso paso a paso de Vogel */}
            {showProcess && steps.length > 0 && (
              <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-white/20">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Proceso Paso a Paso - Método de Vogel</h3>
                <div className="space-y-6">
                          ...
                          <table className="w-full border-collapse text-xs">
                            <thead>
                              <tr>
                                ...
                                {Array(cols).fill(null).map((_, j: number) => (
                                  <th key={j} className="border border-gray-400 p-2 bg-purple-100">
                                    D{j + 1}
                                  </th>
                                ))}
                              </tr>
                            ...
                            <tbody>
                              {Array(rows).fill(null).map((_, i: number) => (
                                <tr key={i}>
                                  <td className="border border-gray-400 p-2 bg-purple-100 font-semibold text-center">
                                    O{i + 1}
                                  </td>
                                  {Array(cols).fill(null).map((_, j: number) => {
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-rose-800">
                    {solution.finalMethod === 'vogel' 
                      ? 'Solución inicial obtenida con el Método de Vogel'
                      : 'Solución inicial obtenida con Método de Vogel + Método de Costo Mínimo'
                    }
